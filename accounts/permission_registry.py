...
FUNCTIONAL_PERMISSIONS = (
    ...
    },
    {
        ...
        "category": "CRM",
        "label": "Consultar CRM",
        "description": "Permite acceder a la información comercial del CRM.",
        "requires": [],
    },
    {
        "code": "crm.manage_campaigns",
        "category": "CRM",
        "label": "Gestionar campañas",
        "description": "Permite crear y administrar campañas comerciales.",
        "requires": ["crm.view_crm"],
    },
    {
        "code": "crm.manage_commercial_teams",
        "category": "CRM",
        "label": "Gestionar equipos comerciales",
        "description": "Permite administrar equipos y membresías comerciales.",
        "requires": ["crm.view_crm"],
    },
    {
        "code": "crm.manage_schools",
        "category": "CRM",
        "label": "Gestionar colegios",
        "description": "Permite registrar y actualizar colegios y sus contactos dentro del alcance visible.",
        "requires": ["crm.view_crm"],
    },
    {
        "code": "crm.assign_schools",
        "category": "CRM",
        "label": "Asignar colegios",
        "description": "Permite asignar o reasignar colegios a asesores.",
        "requires": ["crm.manage_schools"],
    },
    {
        "code": "crm.manage_own_opportunities",
        "category": "CRM",
        "label": "Gestionar oportunidades propias",
        "description": "Permite gestionar oportunidades comerciales dentro del alcance propio.",
        "requires": ["crm.view_crm"],
    },
    {
        "code": "crm.assign_opportunities",
        "category": "CRM",
        "label": "Asignar oportunidades",
        "description": "Permite asignar o reasignar oportunidades comerciales.",
        "requires": ["crm.manage_own_opportunities"],
    },
    {
        "code": "crm.supervise_crm",
        "category": "CRM",
        "label": "Supervisar CRM",
        "description": "Permite supervisar la información de los equipos comerciales donde el usuario es supervisor.",
        "requires": ["crm.view_crm"],
    },
    {
        "code": "crm.manage_quotations",
        "category": "CRM",
        "label": "Gestionar cotizaciones",
        "description": "Reserva la gestión de cotizaciones comerciales para la siguiente fase del CRM.",
        "requires": ["crm.view_crm"],
    },
    {
        "code": "crm.manage_adoptions",
        "category": "CRM",
        "label": "Gestionar adopciones",
        "description": "Reserva la gestión de adopciones comerciales para la siguiente fase del CRM.",
        "requires": ["crm.view_crm"],
    },
    {
        "code": "crm.export_crm_reports",
        "category": "CRM",
        "label": "Exportar reportes CRM",
        "description": "Permite generar exportaciones y reportes comerciales autorizados.",
        "requires": ["crm.view_crm"],
    },
)
